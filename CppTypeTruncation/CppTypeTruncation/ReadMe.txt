========================================================================
    KONSOLENANWENDUNG: CppTypeTruncation-Projektübersicht
========================================================================

Diese CppTypeTruncation-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CppTypeTruncation-Anwendung besteht.


CppTypeTruncation.vcxproj
...
CppTypeTruncation.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CppTypeTruncation.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
